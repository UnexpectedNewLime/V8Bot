...
class Watch(Base):
    ...
    digest_no_update_enabled: Mapped[bool] = mapped_column(Boolean, default=True)
    digest_max_listings: Mapped[int | None] = mapped_column(Integer, nullable=True)
    digest_summary_only: Mapped[bool] = mapped_column(Boolean, default=False)
    digest_immediate_alerts: Mapped[bool] = mapped_column(Boolean, default=False)
    digest_quiet_hours_start: Mapped[time | None] = mapped_column(Time, nullable=True)
    digest_quiet_hours_end: Mapped[time | None] = mapped_column(Time, nullable=True)
    digest_frequency_minutes: Mapped[int] = mapped_column(Integer, default=1440)
